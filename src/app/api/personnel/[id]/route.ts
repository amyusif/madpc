  ...
  try {
    ...
    const row = await prisma.personnel.update({
      ...
      data: {
        ...
        ...(body.date_to_region !== undefined && { date_to_region: body.date_to_region }),
        ...(body.date_to_station !== undefined && { date_to_station: body.date_to_station }),
        ...(body.date_of_last_promotion !== undefined && { date_of_last_promotion: body.date_of_last_promotion }),
